...
MS_COMMAND = "./ms 2 1 -t 1200 -r 400 1000000 -p 6"

#MS_COMMAND = "./ms 2 1 -t 1200 -r 400 1000000 -eN 0.01 0.1 -eN 0.06 1 \
#                -eN 0.2 0.5 -eN 1 1 -eN 2 2 -p 8 -seeds 1747 45896 23615"

# Path to the output file comming from the PSMC
PSMC_RESULTS = "py_results_psmc/Ne_10000_frag_length_1000000_rep_1.psmc"
